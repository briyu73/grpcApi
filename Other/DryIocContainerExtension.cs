...
{
    // Copied from the Prism WPF source code
...
#pragma warning restore CA1001 // Types that own disposable fields should be disposable
    {
        ...
        /// <summary>
        /// These are the Default DryIoc Container Rules from the Prism DryIoc code. This code is
        /// mainly just informational, not used
        /// </summary>
        public static Rules DefaultRules => Rules.Default.WithConcreteTypeDynamicRegistrations(reuse: Reuse.Transient)
                                                         ...
                                                         //.WithoutFastExpressionCompiler() Removed from DryIoc in version 5 onwards
        ...
        public DryIocContainerExtension(IContainer container)
        {
            ...
            }, this, ifAlreadyRegistered: IfAlreadyRegistered.Keep);
        ...
        Type? IContainerInfo.GetRegistrationType(string key)
        {
          ...
          if (matchingRegistration.Factory != null)
          {
