...
namespace FlewsApp.Modules.DBManager.UI.Views
{
  /// <summary>
  /// Interaction logic for EFDataBaseViewerView.xaml
  /// </summary>
  public partial class EFDataBaseViewerView : UserControl
	{
		public EFDataBaseViewerView()
		{
			InitializeComponent();
		}
	}
